...
| `watcher_runs_not_stored_count_total`                              | Total number of runs which were deleted without being stored               | Counter                    | `kind`=&lt;pipelinerun\|taskrun&gt; <br> `namespace`=&lt;run_namespace&gt;                                                                                                                 | experimental |
