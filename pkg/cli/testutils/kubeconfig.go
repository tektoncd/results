...
// CreateTestKubeconfigForExecution creates a temporary kubeconfig file for functional testing
func CreateTestKubeconfigForExecution(t *testing.T) (string, func()) {
	t.Helper()
