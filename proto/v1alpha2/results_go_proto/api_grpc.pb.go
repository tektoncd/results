...
const (
	Events_GetEventList_FullMethodName   = "/tekton.results.v1alpha2.Events/GetEventList"
	Events_ListEventLists_FullMethodName = "/tekton.results.v1alpha2.Events/ListEventLists"
)
...
type EventsClient interface {
	GetEventList(ctx context.Context, in *GetEventListRequest, opts ...grpc.CallOption) (*EventList, error)
	ListEventLists(ctx context.Context, in *ListEventListsRequest, opts ...grpc.CallOption) (*ListEventListResponse, error)
}
...
func (c *eventsClient) GetEventList(ctx context.Context, in *GetEventListRequest, opts ...grpc.CallOption) (*EventList, error) {
	out := new(EventList)
	err := c.cc.Invoke(ctx, Events_GetEventList_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *eventsClient) ListEventLists(ctx context.Context, in *ListEventListsRequest, opts ...grpc.CallOption) (*ListEventListResponse, error) {
	out := new(ListEventListResponse)
	err := c.cc.Invoke(ctx, Events_ListEventLists_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type EventsServer interface {
	GetEventList(context.Context, *GetEventListRequest) (*EventList, error)
	ListEventLists(context.Context, *ListEventListsRequest) (*ListEventListResponse, error)
...
func (UnimplementedEventsServer) GetEventList(context.Context, *GetEventListRequest) (*EventList, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetEventList not implemented")
}
func (UnimplementedEventsServer) ListEventLists(context.Context, *ListEventListsRequest) (*ListEventListResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListEventLists not implemented")
}
...
func _Events_GetEventList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Events_GetEventList_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EventsServer).GetEventList(ctx, req.(*GetEventListRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Events_ListEventLists_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListEventListsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(EventsServer).ListEventLists(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Events_ListEventLists_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EventsServer).ListEventLists(ctx, req.(*ListEventListsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Events_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "tekton.results.v1alpha2.Events",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ListEventLists",
			Handler:    _Events_ListEventLists_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "api.proto",
