...
func (x *LogChunk) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *PutLogSummary) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PutLogSummary) ProtoMessage() {}

func (x *PutLogSummary) ProtoReflect() protoreflect.Message {
	mi := &file_resources_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PutLogSummary.ProtoReflect.Descriptor instead.
func (*PutLogSummary) Descriptor() ([]byte, []int) {
	return file_resources_proto_rawDescGZIP(), []int{5}
}

func (x *PutLogSummary) GetRecord() string {
	if x != nil {
		return x.Record
	}
	return ""
...
func (x *PutLogSummary) GetBytesReceived() int64 {
	if x != nil {
...
var file_resources_proto_rawDesc = []byte{
	...
	0x22, 0x57, 0x0a, 0x08, 0x4c, 0x6f, 0x67, 0x43, 0x68, 0x75, 0x6e, 0x6b, 0x12, 0x37, 0x0a, 0x04,
	0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x42, 0x23, 0xfa, 0x41, 0x20, 0x12,
	...
	0x01, 0x28, 0x0c, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x6d, 0x0a, 0x0d, 0x50, 0x75, 0x74,
	...
	0x52, 0x65, 0x63, 0x65, 0x69, 0x76, 0x65, 0x64, 0x42, 0x3d, 0x5a, 0x3b, 0x67, 0x69, 0x74, 0x68,
...
var file_resources_proto_goTypes = []interface{}{
	...
	(*PutLogSummary)(nil),         // 6: tekton.results.v1alpha2.PutLogSummary
