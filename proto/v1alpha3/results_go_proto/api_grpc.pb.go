...
const (
	Results_CreateResult_FullMethodName         = "/tekton.results.v1alpha3.Results/CreateResult"
	Results_UpdateResult_FullMethodName         = "/tekton.results.v1alpha3.Results/UpdateResult"
	Results_GetResult_FullMethodName            = "/tekton.results.v1alpha3.Results/GetResult"
	Results_DeleteResult_FullMethodName         = "/tekton.results.v1alpha3.Results/DeleteResult"
	Results_ListResults_FullMethodName          = "/tekton.results.v1alpha3.Results/ListResults"
	Results_CreateRecord_FullMethodName         = "/tekton.results.v1alpha3.Results/CreateRecord"
	Results_UpdateRecord_FullMethodName         = "/tekton.results.v1alpha3.Results/UpdateRecord"
	Results_GetRecord_FullMethodName            = "/tekton.results.v1alpha3.Results/GetRecord"
	Results_ListRecords_FullMethodName          = "/tekton.results.v1alpha3.Results/ListRecords"
	Results_DeleteRecord_FullMethodName         = "/tekton.results.v1alpha3.Results/DeleteRecord"
	Results_GetRecordListSummary_FullMethodName = "/tekton.results.v1alpha3.Results/GetRecordListSummary"
)
...
var Results_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "tekton.results.v1alpha3.Results",
...
const (
	...
	Logs_ListLogs_FullMethodName  = "/tekton.results.v1alpha3.Logs/ListLogs"
	Logs_UpdateLog_FullMethodName = "/tekton.results.v1alpha3.Logs/UpdateLog"
	Logs_DeleteLog_FullMethodName = "/tekton.results.v1alpha3.Logs/DeleteLog"
)
